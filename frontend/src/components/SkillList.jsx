...
// カードクリックで command_verb を CommandInput へ送る。
// ----------------
    ...
    <div className="glass p-5 space-y-4">
      ...
      <div className="space-y-1.5">
        {skills.map((skill, idx) => {
          ...
          const isExternalScript = skill.execution_type === 'external_script'
          const isReplay        = skill.skill_type === 'replay'

          return (
            <div
              key={skill.id}
              onClick={() => onSelect?.(skill.command_verb ?? skill.name)}
              className={`
            ...
            >
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                {isExternalScript ? (
                  <span className="text-[9px] px-1.5 py-0.5 border border-sky-500/35 text-sky-400/70 tracking-widest uppercase font-mono">
                    Vision
                  </span>
                ) : (
