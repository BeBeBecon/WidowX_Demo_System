  ...
  return (
    <div className="glass p-6 space-y-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        {/* ----------------
            ボタン行: Execute（flex-1）+ E-Stop の横並び
            ---------------- */}
        <div className="flex gap-2">
          ...
          <button
            ...
            className="btn-neon flex-1 py-3.5 rounded-none font-bold text-sm tracking-[0.15em] uppercase font-mono
          ...
          <button
            ...
            disabled={!isBusy}
            className="btn-neon px-4 py-3.5 rounded-none font-bold text-sm tracking-[0.12em] uppercase font-mono
